<a href="{{ route('backsite.specialist.edit', $id) }}"
...
<form class="inline-block" action="{{ route('backsite.specialist.destroy', $id) }}" method="POST"
    onsubmit="return confirm('Are you sure to delete this specialist?');">
    @csrf
    @method('DELETE')
    <button type="submit"
