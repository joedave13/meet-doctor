<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('backsite.doctor.update', $doctor->id) }}" method="POST"
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="name" name="name"
                        ...
                        placeholder="Doctor name..." value="{{ old('name') ?? $doctor->name }}">
                </div>

                <div class="mb-6">
                    <label for="specialist_id"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Specialist</label>
                ...
                <div class="mb-6">
                    <label for="fee" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Doctor
                        Fee</label>
                    <input type="number" id="fee" name="fee"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Doctor fee..." value="{{ old('fee') ?? $doctor->fee }}">
                </div>
